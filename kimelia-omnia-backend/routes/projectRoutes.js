...
const {
    validateId, // For message ID in params
 ...
 */
router.route('/:id')
    .get(validateId, getMessage)
    .put(validateId, validateUpdateMessage, updateMessage)
    .delete(validateId, deleteMessage);
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.post('/ai/summarize', protect, validateSummarizeContent, summarizeContent);
 ...
 *         $ref: '#/components/responses/ServerError'
 */
router.post('/ai/draft', protect, validateGenerateDraft, generateDraft);
